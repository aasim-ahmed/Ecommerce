...
export default function Clothings({ data, data2 }) {
  ...
  const filteredProducts = data.filter(product => product.category === "men's clothing"||product.category === "women's clothing");
